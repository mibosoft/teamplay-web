...
<div class="content">
	...
	<div class="row">
		<div class="col-md-12">
			<button class="btn btn-default btn-sm active" data-toggle="button"
				aria-pressed="true" id="btn-show-arenas" type="button">
...
<?php echo empty($lodgingplaces) ? "<!--" : ""?>
	<button class="btn btn-default btn-sm" data-toggle="button"
				id="btn-show-lodging" type="button">
...
function initMap() {
  map = new google.maps.Map(document.getElementById('map-container'), {
    ...
    center: {lat: 59.3325800, lng: 18.0649000}
  });
...
function setMarkers(mapLocations,markerArray,icon) {
  ...
  for (var i = 0; i < mapLocations.length; i++) {
    ...
    var marker = new google.maps.Marker({
      position: {lat: mapLocation[1], lng: mapLocation[2]},
      map: map,
      icon: image,
      title: mapLocation[0],
...
$(window).resize(function () {
	...
	<script async defer
		src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDkTnb5G_YoNkyUnTAMPL69n8SrjaxlA8g&callback=initMap">
</script>
	<br>
