	...
	<div class="col-xs-12 col-sm-9">
		<p class="pull-right visible-xs">
			<button type="button" class="btn btn-primary btn-xs"
				data-toggle="offcanvas"><?php echo S_KLASSER?></button>
		</p>
	</div>
	<div class="col-xs-12 col-sm-9">
          ...
          <div id="topCarousel" class="carousel slide"
			...
			<ol class="carousel-indicators">
				...
				<li data-target="#topCarousel" data-slide-to="1"
					<?php echo empty($settings[0]->pic_name_17) ? 'style="display:none"' : "" ?>></li>
				<li data-target="#topCarousel" data-slide-to="2"
					<?php echo empty($settings[0]->pic_name_18) ? 'style="display:none"' : "" ?>></li>
				<li data-target="#topCarousel" data-slide-to="3"
					<?php echo empty($settings[0]->pic_name_19) ? 'style="display:none"' : "" ?>></li>
			</ol>
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img class="first-slide"
						src="<?php echo $GLOBALS['baseUrl'] . $_GET['home'] . '/' . $settings[0]->pic_name_1 ?>"
						alt="First slide">
					<div class="container">
        ...
        <?php echo (empty($settings[0]->pic_name_1) or empty($settings[0]->pic_name_17))? "<!--" : "" ?>
              <div class="item">
					<img class="second-slide"
						src="<?php echo $GLOBALS['baseUrl'] . $_GET['home'] . '/' . $settings[0]->pic_name_17 ?>"
						alt="Second slide">
					<div class="container">
						<div class="carousel-caption">
        ...
        <?php echo (empty($settings[0]->pic_name_1) or empty($settings[0]->pic_name_18))? "<!--" : "" ?>
              <div class="item">
					<img class="third-slide"
						src="<?php echo $GLOBALS['baseUrl'] . $_GET['home'] . '/' . $settings[0]->pic_name_18 ?>"
						alt="Third slide">
					<div class="container">
						<div class="carousel-caption">
        ...
        <?php echo (empty($settings[0]->pic_name_1) or empty($settings[0]->pic_name_19))? "<!--" : "" ?>
              <div class="item">
					<img class="fourth-slide"
						src="<?php echo $GLOBALS['baseUrl'] . $_GET['home'] . '/' . $settings[0]->pic_name_19 ?>"
						alt="Fourth slide">
					<div class="container">
						<div class="carousel-caption">
        ...
        <?php echo empty($settings[0]->pic_name_1) ? "<!--" : "" ?>
			...
			<a class="left carousel-control" href="#topCarousel" role="button"
				data-slide="prev"> <span class="glyphicon glyphicon-chevron-left"
				aria-hidden="true"></span> <span class="sr-only">Previous</span>
			</a> <a class="right carousel-control" href="#topCarousel"
        ...
        <?php echo empty($settings[0]->pic_name_1) ? "-->" : "" ?>
          ...
          <div class="col-md-12" align="right">
			<table>
				<tr>
					<td align="right"><a
						href="?layout=1&home=<?php echo $_GET['home']; ?>&lang=swe"
						class="menu_link"><img src="assets/images//flags_iso/24/se.png"
							border="0" align="middle"></a> <a
						href="?layout=1&home=<?php echo $_GET['home']; ?>&lang=eng"
						class="menu_link"><img src="assets/images/flags_iso/24/gb.png"
							border="0" align="middle"></a> <a
						href="?layout=1&home=<?php echo $_GET['home']; ?>&lang=fin"
						class="menu_link"><img src="assets/images//flags_iso/24/fi.png"
							border="0" align="middle"></a> <a
						href="?layout=1&home=<?php echo $_GET['home']; ?>&lang=nor"
						class="menu_link"><img src="assets/images//flags_iso/24/no.png"
							border="0" align="middle"></a> <a
						href="?layout=1&home=<?php echo $_GET['home']; ?>&lang=cze"
						class="menu_link"><img src="assets/images//flags_iso/24/cz.png"
          ...
          <p><?php echo $baseInfo->bas->info?></p>
			...
			<p>
				<a class="btn btn-info"
					href="?info&home=<?php echo $_GET['home']; ?>" role="button"><?php echo S_MERAINFORMATION?></a>
        ...
        <br>
          ...
          <?php echo S_CUPSIDAINFO?> <a
					href="<?php echo $baseInfo->bas->url?>" target="_blank"><?php echo S_OFFCUPSIDA?></a>.
			</div>
        <?php echo $baseInfo->bas->info == "" ? "" : "-->"?>
        </div>
        ...
        <div class="fb-page"
			data-href="<?php echo $settings[0]->string23 ?>" data-tabs="timeline"
			data-height="<?php echo $settings[0]->value23 ?>"
...
<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
	<div class="list-group">
		<a href="?overview&home=<?php echo $_GET['home']; ?>"
			class="list-group-item disabled"><?php echo S_KLASSER?></a>
            <?php
            if (is_array($classes)) {
	...
	<div class="col-md-12" align="center">
		...
		<h4>
			<span class="label label-danger"><?php echo (date("Y-m-d")<=$baseInfo->bas->start_dat) ? howManyDays(date("Y-m-d"),$baseInfo->bas->start_dat) . "</span> " . S_DAGARKVAR : "" ?>
