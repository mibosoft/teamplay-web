...
<div class="content">
	...
	<ul class="nav nav-pills" role="tablist">
		<li role="presentation"
			...
			href="?teams&home=<?php echo $_GET['home']?>&scope=all&layout=<?php echo $GLOBALS['layout'];?>&lang=<?php echo $GLOBALS['lang'];?>"><?php echo S_SAMTLIGA?></a></li>
  <?php
if (is_array($classes)) {
...
var image = {
  ...
  for (var i = 0; i < teamLocations.length; i++) {
    ...
    var marker = new google.maps.Marker({
      position: {lat: teamLocation[1], lng: teamLocation[2]},
      map: map,
      icon: image,
      shape: shape,
