...
<?php echo $GLOBALS['layout'] == 3 ? "<!--" : "" ?>
        ...
        <div class="col-sm-12">
          <ul class="nav nav-tabs">
            ...
            <li role="presentation"><a title="<?php echo S_OPPNAEGETFONSTER?>" href="?home=<?php echo $_GET['home']; ?>&layout=2&overview" target=_blank"><span class="glyphicon glyphicon-new-window"></span></a></li>
          </ul>              
        </div>
      </div>
<?php echo $GLOBALS['layout'] == 3 ? "-->" : "" ?>
