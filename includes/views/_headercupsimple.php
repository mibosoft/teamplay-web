        ...
        <div class="row">
          <div class="col-sm-12">
            <ul class="nav nav-tabs">
              ...
              <?php echo $settings[0]->value6 == "1" ? '<li role="presentation" ' . (isset($_GET['playerstat']) ? 'class="active"' : '') . '><a href="?home=' . $_GET['home'] . '&layout=2&playerstat&scope=all&sort=' . (($settings[0]->bool25 == 'true') ? "goaldiff" : "points") . '&lang=' . $GLOBALS['lang'] . '">' . S_SPELARSTATISTIK . '</a></li>' : ""; ?>
